...
/** @this {Function} */
(shitsuke.tokens.deep_merge.cljs$lang$applyTo = (function (seq22021){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq22021));
}));
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$pair__GT_css_$_iter__22034(s__22035){
return (new cljs.core.LazySeq(null,(function (){
var s__22035__$1 = s__22035;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22035__$1);
if(temp__5825__auto__){
var s__22035__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22035__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22035__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22037 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22036 = (0);
while(true){
if((i__22036 < size__5479__auto__)){
var vec__22038 = cljs.core._nth(c__5478__auto__,i__22036);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22038,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22038,(1),null);
cljs.core.chunk_append(b__22037,["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22144 = (i__22036 + (1));
i__22036 = G__22144;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22037),shitsuke$tokens$pair__GT_css_$_iter__22034(cljs.core.chunk_rest(s__22035__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22037),null);
}
} else {
var vec__22041 = cljs.core.first(s__22035__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22041,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22041,(1),null);
return cljs.core.cons(["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$tokens$pair__GT_css_$_iter__22034(cljs.core.rest(s__22035__$2)));
}
} else {
return null;
}
...
var body = clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$iter__22053(s__22054){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__22059 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22059,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22059,(1),null);
var iterys__5476__auto__ = ((function (s__22054__$1,vec__22059,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function shitsuke$tokens$iter__22053_$_iter__22055(s__22056){
return (new cljs.core.LazySeq(null,((function (s__22054__$1,vec__22059,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function (){
var s__22056__$1 = s__22056;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22056__$1);
if(temp__5825__auto____$1){
var s__22056__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__22056__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22056__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22058 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22057 = (0);
while(true){
if((i__22057 < size__5479__auto__)){
var vec__22062 = cljs.core._nth(c__5478__auto__,i__22057);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22062,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22062,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__22058,shitsuke.tokens.pair__GT_css(group,k,v));

var G__22172 = (i__22057 + (1));
i__22057 = G__22172;
continue;
} else {
var G__22173 = (i__22057 + (1));
i__22057 = G__22173;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22058),shitsuke$tokens$iter__22053_$_iter__22055(cljs.core.chunk_rest(s__22056__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22058),null);
}
} else {
var vec__22065 = cljs.core.first(s__22056__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22065,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22065,(1),null);
if((!((v == null)))){
return cljs.core.cons(shitsuke.tokens.pair__GT_css(group,k,v),shitsuke$tokens$iter__22053_$_iter__22055(cljs.core.rest(s__22056__$2)));
} else {
var G__22176 = cljs.core.rest(s__22056__$2);
s__22056__$1 = G__22176;
continue;
}
}
} else {
...
});})(s__22054__$1,vec__22059,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
,null,null));
});})(s__22054__$1,vec__22059,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,shitsuke$tokens$iter__22053(cljs.core.rest(s__22054__$1)));
} else {
var G__22177 = cljs.core.rest(s__22054__$1);
s__22054__$1 = G__22177;
continue;
}
} else {
return null;
...
var map__22068 = deck_design;
var map__22068__$1 = cljs.core.__destructure_map(map__22068);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22068__$1,new cljs.core.Keyword("slides","theme","slides/theme",-79736158));
var text_styles = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22068__$1,new cljs.core.Keyword("slides","text-styles","slides/text-styles",-2082623934));
...
var color_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22072){
var vec__22076 = p__22072;
...
var type_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22079){
var vec__22080 = p__22079;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22080,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22080,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,(function (){var G__22084 = cljs.core.PersistentArrayMap.EMPTY;
var G__22084__$1 = (cljs.core.truth_(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22084,new cljs.core.Keyword(null,"font-size","font-size",-1847940346),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts)),"px"].join('')):G__22084);
var G__22084__$2 = (cljs.core.truth_(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22084__$1,new cljs.core.Keyword(null,"color","color",1011675173),shitsuke.tokens.normalize_hex(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))):G__22084__$1);
if(cljs.core.truth_(new cljs.core.Keyword("slides","bold","slides/bold",-1297473049).cljs$core$IFn$_invoke$arity$1(ts))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22084__$2,new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(700));
} else {
return G__22084__$2;
}
})()], null);
})),text_styles);
var font_family = (function (){var or__5002__auto__ = (function (){var G__22097 = new cljs.core.Keyword("office-style.font","majorFont","office-style.font/majorFont",1886256746).cljs$core$IFn$_invoke$arity$1(fonts);
if((G__22097 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22097),", system-ui, sans-serif"].join('');
}
})();
...
var G__22102 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("shitsuke","colors","shitsuke/colors",-494612392),color_tokens], null);
if(cljs.core.seq(type_tokens)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22102,new cljs.core.Keyword("shitsuke","type","shitsuke/type",1602529816),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22104){
var vec__22105 = p__22104;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22105,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22105,(1),null);
