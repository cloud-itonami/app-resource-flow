...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__20111){
var vec__20112 = p__20111;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20112,(0),null);
 ...
 */
shitsuke.hig.default_hig_tokens = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword("hig","font","hig/font",-1506004751),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"text","text",-1790561697),shitsuke.hig.font_family_text,new cljs.core.Keyword(null,"display","display",242065432),shitsuke.hig.font_family_display,new cljs.core.Keyword(null,"mono","mono",-1777958350),shitsuke.hig.font_family_mono], null),new cljs.core.Keyword("hig","text","hig/text",-1790736923),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__20115){
var vec__20116 = p__20115;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20116,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20116,(1),null);
...
})),shitsuke.hig.text_styles),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__20119){
var vec__20120 = p__20119;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20120,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20120,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$pair__GT_css_$_iter__20220(s__20221){
return (new cljs.core.LazySeq(null,(function (){
var s__20221__$1 = s__20221;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__20221__$1);
if(temp__5825__auto__){
var s__20221__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20221__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__20221__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__20223 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__20222 = (0);
while(true){
if((i__20222 < size__5479__auto__)){
var vec__20227 = cljs.core._nth(c__5478__auto__,i__20222);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20227,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20227,(1),null);
cljs.core.chunk_append(b__20223,["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__20365 = (i__20222 + (1));
i__20222 = G__20365;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20223),shitsuke$hig$pair__GT_css_$_iter__20220(cljs.core.chunk_rest(s__20221__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20223),null);
}
} else {
var vec__20231 = cljs.core.first(s__20221__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20231,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20231,(1),null);
return cljs.core.cons(["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$hig$pair__GT_css_$_iter__20220(cljs.core.rest(s__20221__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$tokens__GT_css_lines_$_iter__20255(s__20256){
return (new cljs.core.LazySeq(null,(function (){
var s__20256__$1 = s__20256;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__20256__$1);
if(temp__5825__auto__){
var s__20256__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20256__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__20256__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__20258 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__20257 = (0);
while(true){
if((i__20257 < size__5479__auto__)){
var vec__20260 = cljs.core._nth(c__5478__auto__,i__20257);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20260,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20260,(1),null);
if((!((m == null)))){
cljs.core.chunk_append(b__20258,((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (i__20257,s__20256__$1,vec__20260,group,m,c__5478__auto__,size__5479__auto__,b__20258,s__20256__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__20255_$_iter__20263(s__20264){
return (new cljs.core.LazySeq(null,((function (i__20257,s__20256__$1,vec__20260,group,m,c__5478__auto__,size__5479__auto__,b__20258,s__20256__$2,temp__5825__auto__){
return (function (){
var s__20264__$1 = s__20264;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__20264__$1);
if(temp__5825__auto____$1){
var s__20264__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__20264__$2)){
var c__5478__auto____$1 = cljs.core.chunk_first(s__20264__$2);
var size__5479__auto____$1 = cljs.core.count(c__5478__auto____$1);
var b__20266 = cljs.core.chunk_buffer(size__5479__auto____$1);
if((function (){var i__20265 = (0);
while(true){
if((i__20265 < size__5479__auto____$1)){
var vec__20270 = cljs.core._nth(c__5478__auto____$1,i__20265);
...
if((!((v == null)))){
cljs.core.chunk_append(b__20266,shitsuke.hig.pair__GT_css(group,k,v));

var G__20366 = (i__20265 + (1));
i__20265 = G__20366;
continue;
} else {
var G__20367 = (i__20265 + (1));
i__20265 = G__20367;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20266),shitsuke$hig$tokens__GT_css_lines_$_iter__20255_$_iter__20263(cljs.core.chunk_rest(s__20264__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20266),null);
}
} else {
var vec__20273 = cljs.core.first(s__20264__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__20255_$_iter__20263(cljs.core.rest(s__20264__$2)));
} else {
var G__20368 = cljs.core.rest(s__20264__$2);
s__20264__$1 = G__20368;
continue;
}
}
} else {
...
});})(i__20257,s__20256__$1,vec__20260,group,m,c__5478__auto__,size__5479__auto__,b__20258,s__20256__$2,temp__5825__auto__))
,null,null));
});})(i__20257,s__20256__$1,vec__20260,group,m,c__5478__auto__,size__5479__auto__,b__20258,s__20256__$2,temp__5825__auto__))
;
...
var G__20369 = (i__20257 + (1));
i__20257 = G__20369;
continue;
} else {
var G__20370 = (i__20257 + (1));
i__20257 = G__20370;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20258),shitsuke$hig$tokens__GT_css_lines_$_iter__20255(cljs.core.chunk_rest(s__20256__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20258),null);
}
} else {
var vec__20279 = cljs.core.first(s__20256__$2);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20279,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20279,(1),null);
if((!((m == null)))){
return cljs.core.cons(((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (s__20256__$1,vec__20279,group,m,s__20256__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__20255_$_iter__20282(s__20283){
return (new cljs.core.LazySeq(null,((function (s__20256__$1,vec__20279,group,m,s__20256__$2,temp__5825__auto__){
return (function (){
var s__20283__$1 = s__20283;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__20283__$1);
if(temp__5825__auto____$1){
var s__20283__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__20283__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__20283__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__20285 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__20284 = (0);
while(true){
if((i__20284 < size__5479__auto__)){
var vec__20292 = cljs.core._nth(c__5478__auto__,i__20284);
...
if((!((v == null)))){
cljs.core.chunk_append(b__20285,shitsuke.hig.pair__GT_css(group,k,v));

var G__20371 = (i__20284 + (1));
i__20284 = G__20371;
continue;
} else {
var G__20372 = (i__20284 + (1));
i__20284 = G__20372;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20285),shitsuke$hig$tokens__GT_css_lines_$_iter__20255_$_iter__20282(cljs.core.chunk_rest(s__20283__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20285),null);
}
} else {
var vec__20299 = cljs.core.first(s__20283__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__20255_$_iter__20282(cljs.core.rest(s__20283__$2)));
} else {
var G__20373 = cljs.core.rest(s__20283__$2);
s__20283__$1 = G__20373;
continue;
}
}
} else {
...
});})(s__20256__$1,vec__20279,group,m,s__20256__$2,temp__5825__auto__))
,null,null));
});})(s__20256__$1,vec__20279,group,m,s__20256__$2,temp__5825__auto__))
;
return iter__5480__auto__(m);
})()):["  --hig-",cljs.core.name(group),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(m),";"].join('')),shitsuke$hig$tokens__GT_css_lines_$_iter__20255(cljs.core.rest(s__20256__$2)));
} else {
var G__20374 = cljs.core.rest(s__20256__$2);
s__20256__$1 = G__20374;
continue;
}
}
} else {
 ...
 *   `@layer kotoba.hig`.
 */
shitsuke.hig.text_style_classes = ["@layer kotoba.hig {\n",clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$iter__20342(s__20343){
return (new cljs.core.LazySeq(null,(function (){
var s__20343__$1 = s__20343;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__20343__$1);
if(temp__5825__auto__){
var s__20343__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20343__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__20343__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__20345 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__20344 = (0);
while(true){
if((i__20344 < size__5479__auto__)){
var style = cljs.core._nth(c__5478__auto__,i__20344);
cljs.core.chunk_append(b__20345,[".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''));

var G__20379 = (i__20344 + (1));
i__20344 = G__20379;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20345),shitsuke$hig$iter__20342(cljs.core.chunk_rest(s__20343__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20345),null);
}
} else {
var style = cljs.core.first(s__20343__$2);
return cljs.core.cons([".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''),shitsuke$hig$iter__20342(cljs.core.rest(s__20343__$2)));
}
} else {
return null;
}
