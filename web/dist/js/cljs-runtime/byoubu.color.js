...
var h__$1 = (function (){var G__22782 = h;
if(clojure.string.starts_with_QMARK_(h,"#")){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__22782,(1));
} else {
return G__22782;
}
})();
 ...
 */
byoubu.color.rgb__GT_hex = (function byoubu$color$rgb__GT_hex(p__22795){
var vec__22796 = p__22795;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22796,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22796,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22796,(2),null);
...
var vec__22806 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22806,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22806,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22806,(2),null);
...
var pairs = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__22819){
var vec__22820 = p__22819;
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22820,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22820,(1),null);
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
...
if((total > (0))){
return byoubu.color.rgb__GT_hex((function (){var iter__5480__auto__ = (function byoubu$color$mix_$_iter__22824(s__22825){
return (new cljs.core.LazySeq(null,(function (){
var s__22825__$1 = s__22825;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22825__$1);
if(temp__5825__auto__){
var s__22825__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22825__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22825__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22827 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22826 = (0);
while(true){
if((i__22826 < size__5479__auto__)){
var i = cljs.core._nth(c__5478__auto__,i__22826);
cljs.core.chunk_append(b__22827,(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,0.0,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i__22826,i,c__5478__auto__,size__5479__auto__,b__22827,s__22825__$2,temp__5825__auto__,pairs,total){
return (function (p__22831){
var vec__22832 = p__22831;
var rgb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22832,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22832,(1),null);
return (w * cljs.core.nth.cljs$core$IFn$_invoke$arity$2(rgb,i));
});})(i__22826,i,c__5478__auto__,size__5479__auto__,b__22827,s__22825__$2,temp__5825__auto__,pairs,total))
,pairs)) / total));

var G__22983 = (i__22826 + (1));
i__22826 = G__22983;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22827),byoubu$color$mix_$_iter__22824(cljs.core.chunk_rest(s__22825__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22827),null);
}
} else {
var i = cljs.core.first(s__22825__$2);
return cljs.core.cons((cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,0.0,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i,s__22825__$2,temp__5825__auto__,pairs,total){
return (function (p__22836){
var vec__22837 = p__22836;
var rgb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22837,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22837,(1),null);
return (w * cljs.core.nth.cljs$core$IFn$_invoke$arity$2(rgb,i));
});})(i,s__22825__$2,temp__5825__auto__,pairs,total))
,pairs)) / total),byoubu$color$mix_$_iter__22824(cljs.core.rest(s__22825__$2)));
}
} else {
return null;
}
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22840 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22840,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22840,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22840,(2),null);
var r__$1 = (r / 255.0);
var g__$1 = (g / 255.0);
var b__$1 = (b / 255.0);
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22844 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22844,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22844,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22844,(2),null);
var r__$1 = (r / 255.0);
var g__$1 = (g / 255.0);
var b__$1 = (b / 255.0);
var mx = (function (){var x__5087__auto__ = (function (){var x__5087__auto__ = r__$1;
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22850 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22850,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22850,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22850,(2),null);
