...
return byoubu.color.mix((function (){var iter__5480__auto__ = (function byoubu$facts$declared_content_color_$_iter__22867(s__22868){
...
var vec__22883 = cljs.core._nth(c__5478__auto__,i__22869);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22883,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22883,(1),null);
cljs.core.chunk_append(b__22870,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null));

var G__22913 = (i__22869 + (1));
i__22869 = G__22913;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22870),byoubu$facts$declared_content_color_$_iter__22867(cljs.core.chunk_rest(s__22868__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22870),null);
}
} else {
var vec__22886 = cljs.core.first(s__22868__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22886,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22886,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null),byoubu$facts$declared_content_color_$_iter__22867(cljs.core.rest(s__22868__$2)));
}
} else {
return null;
}
...
var G__22889 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"declared","declared",92336021),byoubu.facts.declared_content_color(backdrop)], null);
var G__22889__$1 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22889,new cljs.core.Keyword(null,"plate","plate",-1920178141),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null))):G__22889);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22889__$1,new cljs.core.Keyword(null,"poster","poster",-1616913550),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"poster","poster",-1616913550),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)));
} else {
return G__22889__$1;
}
});
...
return cljs.core.first(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p__22891){
var vec__22892 = p__22891;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22892,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22892,(1),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22892,(2),null);
return (- r);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__22895){
var vec__22896 = p__22895;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22896,(0),null);
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22896,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,hex,cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22890_SHARP_){
var or__5002__auto__ = byoubu.color.contrast_ratio(hex,p1__22890_SHARP_);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return 0.0;
...
var vec__22899 = byoubu.facts.best_ink(cljs.core.vals(tiers));
var ink_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22899,(0),null);
var ink = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22899,(1),null);
var ratio = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22899,(2),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22906),byoubu$facts$derive_facts_$_iter__22903(cljs.core.chunk_rest(s__22904__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22906),null);
}
} else {
var vec__22910 = cljs.core.first(s__22904__$2);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22910,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22910,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t,byoubu.color.contrast_ratio(ink,c)], null),byoubu$facts$derive_facts_$_iter__22903(cljs.core.rest(s__22904__$2)));
}
} else {
return null;
}
