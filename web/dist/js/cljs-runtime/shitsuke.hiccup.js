...
var vec__21996 = node;
var seq__21997 = cljs.core.seq(vec__21996);
var first__21998 = cljs.core.first(seq__21997);
var seq__21997__$1 = cljs.core.next(seq__21997);
var t = first__21998;
var body = seq__21997__$1;
var vec__21999 = (shitsuke.hiccup.parse_tag.cljs$core$IFn$_invoke$arity$1 ? shitsuke.hiccup.parse_tag.cljs$core$IFn$_invoke$arity$1(t) : shitsuke.hiccup.parse_tag.call(null, t));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21999,(0),null);
var base = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21999,(1),null);
var vec__22002 = ((cljs.core.map_QMARK_(cljs.core.first(body)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(body),cljs.core.rest(body)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,body], null));
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22002,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22002,(1),null);
...
var attrs__$2 = (function (){var G__22010 = attrs__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tag,"textarea")){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__22010,new cljs.core.Keyword(null,"value","value",305978217));
} else {
return G__22010;
}
})();
...
var content_22015 = shitsuke.hiccup.raw_text_content(children);
shitsuke.hiccup.assert_no_rawtext_breakout_BANG_(tag,content_22015);

cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(sb,content_22015);
} else {
