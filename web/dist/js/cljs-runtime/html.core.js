...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,(function (){var G__21894 = cljs.core.PersistentArrayMap.EMPTY;
var G__21894__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21894,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes)):G__21894);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21894__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__21894__$1;
}
})()], null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("",cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__21905){
var vec__21907 = p__21905;
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__21911){
var vec__21912 = p__21911;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21912,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21912,(1),null);
if(cljs.core.truth_((function (){var and__5000__auto__ = v;
if(cljs.core.truth_(and__5000__auto__)){
return (!(v === false));
} else {
...
var vec__21916 = html.core.parse_tag(cljs.core.first(x));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21916,(0),null);
...
var t = first__21927;
var body = seq__21926__$1;
var vec__21928 = html.core.parse_tag(t);
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21928,(0),null);
var base = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21928,(1),null);
var vec__21931 = ((cljs.core.map_QMARK_(cljs.core.first(body)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(body),cljs.core.rest(body)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,body], null));
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21931,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21931,(1),null);
...
var len__5726__auto___21982 = arguments.length;
var i__5727__auto___21983 = (0);
while(true){
if((i__5727__auto___21983 < len__5726__auto___21982)){
args__5732__auto__.push((arguments[i__5727__auto___21983]));

var G__21984 = (i__5727__auto___21983 + (1));
i__5727__auto___21983 = G__21984;
continue;
} else {
}
break;
...
/** @this {Function} */
(html.core.html.cljs$lang$applyTo = (function (seq21941){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21941));
}));
...
var args__5732__auto__ = [];
var len__5726__auto___21985 = arguments.length;
var i__5727__auto___21986 = (0);
while(true){
if((i__5727__auto___21986 < len__5726__auto___21985)){
args__5732__auto__.push((arguments[i__5727__auto___21986]));

var G__21987 = (i__5727__auto___21986 + (1));
i__5727__auto___21986 = G__21987;
continue;
} else {
}
break;
...
/** @this {Function} */
(html.core.html5.cljs$lang$applyTo = (function (seq21946){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21946));
}));
