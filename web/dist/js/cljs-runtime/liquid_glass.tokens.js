...
(liquid_glass.tokens.spring_linear_easing.cljs$core$IFn$_invoke$arity$1 = (function (p__22133){
var map__22134 = p__22133;
var map__22134__$1 = cljs.core.__destructure_map(map__22134);
var zeta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22134__$1,new cljs.core.Keyword(null,"zeta","zeta",257464678),0.55);
var omega = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22134__$1,new cljs.core.Keyword(null,"omega","omega",277265652),13.0);
var samples = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22134__$1,new cljs.core.Keyword(null,"samples","samples",635504833),(16));
...
return ["linear(",clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$iter__22146(s__22147){
...
var i = cljs.core._nth(c__5478__auto__,i__22148);
cljs.core.chunk_append(b__22149,fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))));

var G__22304 = (i__22148 + (1));
i__22148 = G__22304;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22149),liquid_glass$tokens$iter__22146(cljs.core.chunk_rest(s__22147__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22149),null);
}
} else {
var i = cljs.core.first(s__22147__$2);
return cljs.core.cons(fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))),liquid_glass$tokens$iter__22146(cljs.core.rest(s__22147__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$pair__GT_css_$_iter__22168(s__22169){
return (new cljs.core.LazySeq(null,(function (){
var s__22169__$1 = s__22169;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22169__$1);
if(temp__5825__auto__){
var s__22169__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22169__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22169__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22171 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22170 = (0);
while(true){
if((i__22170 < size__5479__auto__)){
var vec__22218 = cljs.core._nth(c__5478__auto__,i__22170);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22218,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22218,(1),null);
cljs.core.chunk_append(b__22171,["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22307 = (i__22170 + (1));
i__22170 = G__22307;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22171),liquid_glass$tokens$pair__GT_css_$_iter__22168(cljs.core.chunk_rest(s__22169__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22171),null);
}
} else {
var vec__22224 = cljs.core.first(s__22169__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22224,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22224,(1),null);
return cljs.core.cons(["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),liquid_glass$tokens$pair__GT_css_$_iter__22168(cljs.core.rest(s__22169__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$tokens__GT_body_$_iter__22231(s__22232){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__22245 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22245,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22245,(1),null);
var iterys__5476__auto__ = ((function (s__22232__$1,vec__22245,group,m,xs__6385__auto__,temp__5825__auto__){
return (function liquid_glass$tokens$tokens__GT_body_$_iter__22231_$_iter__22233(s__22234){
return (new cljs.core.LazySeq(null,((function (s__22232__$1,vec__22245,group,m,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__22234__$1 = s__22234;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22234__$1);
if(temp__5825__auto____$1){
var s__22234__$2 = temp__5825__auto____$1;
...
var vec__22251 = cljs.core._nth(c__5478__auto__,i__22235);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22251,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22251,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__22236,liquid_glass.tokens.pair__GT_css(group,k,v));

var G__22317 = (i__22235 + (1));
i__22235 = G__22317;
continue;
} else {
var G__22318 = (i__22235 + (1));
i__22235 = G__22318;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22236),liquid_glass$tokens$tokens__GT_body_$_iter__22231_$_iter__22233(cljs.core.chunk_rest(s__22234__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22236),null);
}
} else {
var vec__22254 = cljs.core.first(s__22234__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22254,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22254,(1),null);
if((!((v == null)))){
return cljs.core.cons(liquid_glass.tokens.pair__GT_css(group,k,v),liquid_glass$tokens$tokens__GT_body_$_iter__22231_$_iter__22233(cljs.core.rest(s__22234__$2)));
} else {
var G__22322 = cljs.core.rest(s__22234__$2);
s__22234__$1 = G__22322;
continue;
}
}
} else {
...
});})(s__22232__$1,vec__22245,group,m,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__22232__$1,vec__22245,group,m,xs__6385__auto__,temp__5825__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,liquid_glass$tokens$tokens__GT_body_$_iter__22231(cljs.core.rest(s__22232__$1)));
} else {
var G__22323 = cljs.core.rest(s__22232__$1);
s__22232__$1 = G__22323;
continue;
}
} else {
return null;
